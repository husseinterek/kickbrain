...
<body class="vertical-layout vertical-menu-modern 1-column blank-page" data-menu="vertical-menu-modern" data-col="1-column" style='background-color: #282828'>
	...
	<div class="app-content content">
		...
		<div class="content-wrapper" style='background-color: #282828'>
			<div class="content-body">
				<!-- users list start -->
                <section class="answers-list-wrapper">
					...
					<div class='row mt-2'>
                    	<div class='col-10 offset-1 my-auto'>
                    		<div class='row'>
                    			<div class='col-6'>
                    				<input type="button" id='addnewAnswerBtn' class="btn btn-info" value="Add New Answer">
                    				<a href="/admin" target="_blank" class="btn btn-success" role="button" style='margin-left: 10px'><span>Questions Management</span></a>
                    			</div>
                    			<div class='col-6' style='color: white'>
                    				<span>Answers Management</span>
                    			</div>
                    		</div>
                    	</div>
					</div>
					<div class='row mt-1'>
						<div class='col-10 offset-1 my-auto'>
							<div class="answers-list-table">
		                        <div class="card">
		                            <div class="card-content">
		                                <div class="card-body">
												<div class="table-responsive">
			                                        <table id="answers-list-datatable" class="table">
			                                            <thead>
			                                                <tr>
			                                                    <th style="width: 40%">Name Ar</th>
		         ...
		         <form novalidate id='newDashboardForm'>
		             <div class="modal-body">
		             	<div class="form-group">
		                 	<div class="row">
		                 		<input type="hidden" class="form-control" id="answer-id">
		                 		<div class='col-12'>
		                 			<input type="text" placeholder="Description Ar" class="form-control mt-1" id="answer-desc-ar">
		                 		</div>
		                 		<div class='col-12'>
		                 			<input type="text" placeholder="Description En" class="form-control mt-1" id="answer-desc-en">
		                 		</div>
		                 		<div class='col-12 mt-1'>
		                 			<select id="answer-type">
										<option value='1' selected>Player/Manager</option>
		             ...
		             <div class="modal-footer">
		             	 <input type="button" id='saveAnswerBtn' class="btn btn-info" value="Save">
    ...
    <script src="<c:url value="${pageContext.request.contextPath}/static/js/admin-answers.js"/>"></script>
    <!-- END: Page JS-->
