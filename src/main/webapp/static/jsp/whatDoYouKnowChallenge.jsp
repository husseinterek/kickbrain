...
<head>
    ...
    <script>
    	...
    	var isSingleGame='<c:out value='${isSingleGame}'/>';
...
<body class="vertical-layout vertical-menu-modern 1-column blank-page" data-menu="vertical-menu-modern" data-col="1-column" style='background-color: #282828;'>
    ...
    <script src="<c:url value="${pageContext.request.contextPath}/static/js/whatDoYouKnowChallenge.js"/>"></script>
    <!-- END: Page JS-->
