...
$(document).ready(function() {
	...
	typeQuestion("Name 3 players who won the Champions League in the history!", 0);
...
function typeQuestion(name, iteration) {
    ...
    setTimeout(function() {
        ...
        $('.question .question-description').html( $('.question .question-description').html() + name[iteration++] );

        // Re-trigger our function
        typeQuestion(name, iteration);
    }, 50);
}